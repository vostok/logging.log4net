...
namespace Vostok.Logging.Log4net.Tests
{
    ...
    internal class Log4netHierarchicalLog_Tests
    {
        ...
        public void TestSetup()
        {
            ...
            adapter = new Log4netHierarchicalLog(log4netLogger);
        }
        ...
        [Test]
        public void ForContext_call_chain_should_produce_a_wrapper_around_a_logger_with_hierarchical_name()
        {
            adapter = adapter
                .ForContext("name1")
                .ForContext("name2")
            ...
            ObservedEvent.LoggerName.Should().Be("name1-name2-name3");
        }
